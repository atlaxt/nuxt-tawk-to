---
title: API Usage
description: Control the Tawk.to widget programmatically in Nuxt using Vue's inject/provide — toggle, maximize, minimize, identify visitors and more. Works with Nuxt 3 and Nuxt 4.
seo:
  title: 'API Usage — Control Tawk.to Widget Programmatically in Nuxt'
  description: 'Use the full Tawk.to JavaScript API in Nuxt (v3 & v4) via nuxt-tawk-to. Toggle, maximize, minimize the widget, identify visitors, add tags — all via Vue inject.'
navigation:
