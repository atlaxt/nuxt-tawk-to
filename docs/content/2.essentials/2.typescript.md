---
title: TypeScript
description: nuxt-tawk-to ships with full TypeScript support — import TawkToConfig types and get autocomplete for all Tawk.to options in Nuxt.
seo:
  title: 'TypeScript — Fully Typed Tawk.to Config in Nuxt (v3 & v4)'
  description: 'nuxt-tawk-to provides complete TypeScript definitions for Nuxt 3 and Nuxt 4. Import TawkToConfig to type propertyId, widgetId, embedId, basePath, and autoStart with full autocomplete.'
navigation:
